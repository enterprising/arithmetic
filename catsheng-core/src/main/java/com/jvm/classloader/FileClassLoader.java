...
/**
 * 参考文档：https://blog.csdn.net/javazejian/article/details/73413292
 */
public class FileClassLoader extends ClassLoader {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
         ...
         * 利用defineClass()方法创建了类的class对象。在main方法中调用了loadClass()方法加载指定路径下的class文件，
         * 由于启动类加载器、拓展类加载器以及系统类加载器都无法在其路径下找到该类，因此最终将有自定义类加载器加载，
         * 即调用findClass()方法进行加载。
         */
    }
}